    ...
    u.bindClick = function(ctx){
        ...
        $("#ul-edit").click(function(){
            ...
            if(isSelected){
                ...
                var id = $(that).val();
                window.location.href = ctx+"/back/category/update?categoryId="+id;
            }else{
        ...
        $("#ul-delete").click(function(){
            ...
            if(isSelected){
                ...
                parent.delConfig(obj,ctx,"/back/category/delete");
            }else{
                layer.msg('您没有选中如何数据请选择后操作', {time:2000, icon:0});
            }
        });
