...
<div class="form-table">
    <form class="registerform" id="addProSalesForm" action="${ctx}/back/productSales/save" method="post" enctype="multipart/form-data">
        <div class="basicInfo ui-box">
            ...
            <div class="filedList">
                <label>选择产品</label>
                <select class="form-control inputXt" name="productId" id="productId"
                        ajaxurl="${ctx}/back/productSales/checkProSales"
                        auto_color_flag="true" datatype="*" nullmsg="请选择产品!">
            ...
            <div class="filedList">
                <label>规格</label>
                <select class="form-control inputXt" name="salesMethod">
            ...
            <div class="filedList">
                ...
                <input type="text" class="form-control inputXt" placeholder="斤数" name="poundsNum"
                       ...
                       nullmsg="请输入斤数!" errormsg="必须为整数数字"/>
                <span style="color:#a9a9a9;">规格为斤则是起售斤数，规格为箱则是每箱斤数</span>
            </div>
            <div class="filedList">
                <label>是否包邮</label>
                <select class="form-control inputXt" name="isFreePost">
            ...
            <div class="filedList">
                <label>起邮斤数</label>
                <input type="text" class="form-control inputXt" placeholder="起邮斤数" name="freePostJin" value="0"/>
            </div>
            <div class="filedList">
                <label>邮费</label>
                <input type="text" class="form-control inputXt" placeholder="邮费" name="postMoney" value="0"/>
            </div>
            <div class="filedList">
                <label>赠送果币</label>
                <input type="text" class="form-control inputXt" placeholder="赠送果币" name="fruitScore" value="0"/>
            </div>
        </div>
        <!--提交取消-->
