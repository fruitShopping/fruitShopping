...
<!DOCTYPE html>
    <header>
        ...
        <title>用户注册</title>
        <meta name="author" content="microCredit Team">
        <meta name="copyright" content="microCredit">
        <meta name="keywords" content="microCredit商城">
        <link href="${pageContext.request.contextPath}/resources/css/newCss/style.css" rel="stylesheet" type="text/css">
        <%--<link href="${pageContext.request.contextPath}/resources/css/common.css" rel="stylesheet" type="text/css">--%>
        <link href="${pageContext.request.contextPath}/resources/css/register.css" rel="stylesheet" type="text/css">
        <script src="${pageContext.request.contextPath}/resources/js/jquery/jquery-1.10.1.min.js" type="text/javascript"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/jquery/common.js"></script>
        <script src="${pageContext.request.contextPath}/resources/js/jquery/jquery.validate.js" type="text/javascript"></script>
...
<!-- BEGIN BODY -->
    <body>
    <!--页面头部 -->
    <%@include file="body/newheader.jsp"%>
            ...
            <div class="span12">
                <div class="wrap">
                    <div class="main clearfix">
                        ...
                        <form id="registerForm" action="/register/handelRegister" method="post" novalidate="novalidate">
                            <table>
                                <tbody>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="text" id="username" name="username" class="text" maxlength="20" value="${user.username}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" name="rePassword" class="text" maxlength="20" autocomplete="off" value="${user.password}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="text" id="email" name="email" class="text" maxlength="200" value="${user.email}">
                                    </td>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <td>
                                        <input type="text" name="real_name" class="text" maxlength="200" value="${user.real_name}">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="mobile" class="text" maxlength="200" value="${user.mobile}">
                                    </td>
                                </tr>
    ...
    <!--页面底部-->
    <%@include file="body/newFooter.jsp"%>
    </body>
</html>